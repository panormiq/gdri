/**
 * FICHIER : modules/gderpi/backend/services/pdf/renderCommandeClientHtml.js
 * RÔLE : Génère le document HTML complet d'une commande client.
 */
...
function renderCommandeClientHtml(context) {
...
<head>
  <meta charset="UTF-8">
  <title>Commande client ${esc(c.numero || '')}</title>
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .gderpi-devis-doc__title { margin: 0; font-size: 26px; font-weight: 800; color: ${ACCENT}; }
    .gderpi-devis-doc__meta { margin-top: 8px; font-size: 12px; color: #64748b; }
    .gderpi-devis-doc__client { background: #fff7ed; border: 1px solid #fed7aa; border-radius: 8px; text-align: left; font-size: 12px; }
    ...
    .gderpi-devis-doc__footer-cgv-link { color: ${ACCENT}; font-weight: 600; }
      ...
      <div class="gderpi-devis-doc__sheet-body">
        <header class="gderpi-devis-doc__header">
          ...
          <div class="gderpi-devis-doc__title-block">
            <h1 class="gderpi-devis-doc__title">COMMANDE CLIENT</h1>
...
module.exports = renderCommandeClientHtml;
