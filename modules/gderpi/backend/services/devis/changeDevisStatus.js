 ...
 *
 * ENTRÉES : db, entrepriseId, devisId, nouveauStatut
 * SORTIES : Devis mis à jour
 *
 * DÉPEND DE : getDevisById.js, toDevisEntry.js
...
async function changeDevisStatus(db, entrepriseId, devisId, newStatus) {
