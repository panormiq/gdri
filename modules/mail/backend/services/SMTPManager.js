...
class SMTPManager {
  ...
  /**
   * Liste des profils SMTP disponibles
   * @returns {string[]} Liste des clés de profils
   */
  getProfileKeys() {
  ...
  /**
   * Choisit un profil par priorité, sinon le premier disponible
   * @param {string[]} preferredKeys
   * @returns {string|null}
   */
  getPreferredProfile(preferredKeys = []) {
    const available = this.getProfileKeys();
