<?php
/**
 * Mon espace — Agents assistés (validation humaine / WYSIWYG).
 */
...
$page_title = 'Agents assistés';
$jwt_token = getJWTToken();
$api_base_url = rtrim(getApiBaseUrl(), '/');
$createAgentUrl = url('pages/entity-agent-editor.php') . '?space=user&return=assisted';
...
renderConsoleLayoutStart(
    'Agents assistés',
    'Flows avec étape humaine : revue documentaire WYSIWYG, validation ou rejet.',
