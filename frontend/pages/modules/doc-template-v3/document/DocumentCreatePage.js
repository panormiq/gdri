...
export default class DocumentCreatePage extends Page {
  ...
  loadStyles() {
    if (!document.getElementById('documentcreatepage-styles')) {
      const link = document.createElement('link');
      link.id = 'documentcreatepage-styles';
      link.rel = 'stylesheet';
      const baseUrl = window.BASE_URL || '/';
      link.href = baseUrl + 'pages/modules/doc-template-v3/document/DocumentCreatePage.css';
