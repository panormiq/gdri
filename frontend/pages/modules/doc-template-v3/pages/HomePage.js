export default class HomePage {
  ...
  async render(container) {
    ...
    const cards = [
      {
        title: 'Templates',
        description: 'Un modèle : Word, canvas A4, HTML ou prompt IA',
        icon: 'template',
        link: '/templates',
  ...
  createCard(data) {
    ...
    const iconLibrary = {
      ...
      canvas: '<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="2" width="16" height="20" rx="2"/><path d="M8 6h8"/><path d="M8 10h8"/><path d="M8 14h5"/></svg>'
    };
    ...
    if (data.href) {
      button.target = data.target || '_self';
    } else {
