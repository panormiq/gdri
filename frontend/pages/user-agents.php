<?php
/**
 * Mon espace — Agents (liste unique).
 */
...
$createAgentUrl = url('pages/entity-agent-editor.php') . '?space=user&return=agents';
...
renderConsoleLayoutStart(
    'Agents',
    'Automatisations basées sur des blocs génériques (déclencher, données, condition, action, validation, sortie).',
